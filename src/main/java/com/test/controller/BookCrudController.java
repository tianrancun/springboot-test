...
//
//import com.test.dao.elasticsearch.BookRepository;
//import com.test.model.elasticsearch.Book;
...
//        //first document
//        Book book = new Book();//Book.builder().id("123456").title("build2").build();
//        book.setId("123456");
//        book.setTitle("build2");
...
//
//        //second document
//        Book book2 = new Book();//Book.builder().id("123457").title("build3").build();
//        book2.setId("123457");
//        book2.setTitle("build3");
//
